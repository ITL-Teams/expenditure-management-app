<?php
namespace App\Application\BudgeCollaboratorIdFinder;
...
class BudgeCollaboratorIdFinder {
  ...
  public function invoke(BudgeCollaboratorIdFinderRequest $request): BudgetsCollaboratorData {
